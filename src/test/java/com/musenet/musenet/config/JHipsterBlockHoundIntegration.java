package com.musenet.musenet.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.musenet.musenet.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.musenet.musenet.security.DomainUserDetailsService", "createSpringSecurityUser");
